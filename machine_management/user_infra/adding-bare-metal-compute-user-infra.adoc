...
[IMPORTANT]
====
If you do not have access to the {op-system-first} images that were used to create your cluster, it is possible to add more compute machines to your {product-title} cluster with newer versions of {op-system-first} images.  See the following https://access.redhat.com/solutions/5514051[support article on access.redhat.com] for instructions.
====
