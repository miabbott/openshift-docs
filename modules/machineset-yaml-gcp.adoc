...
<5> Specify the path to the image which is used in current MachineSets.  If you have the OpenShift CLI installed, you can obtain the path to the image by running the following command:
+
[source,terminal]
----
